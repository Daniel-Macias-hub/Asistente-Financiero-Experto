...
Crea imágenes de referencia sintéticas para bitcoin, ethereum, solana, cardano y xrp,
...
def crear_imagen_logo(nombre, color_bg, color_fg, texto_simbolo):
    ...
    # Dibujar circulo contenedor
    cv2.circle(img, (150, 150), 120, color_fg, 10)
    
    # Dibujar formas geometricas internas segun cripto
    if nombre == "bitcoin":
        # Simbolo B de Bitcoin
